  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-de-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro de Fisioterapia Madridejos Ángel Rodríguez Rodríguez"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-de-fisioterapia"
          data-primary-color="#ab9672"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-de-fisioterapia";
